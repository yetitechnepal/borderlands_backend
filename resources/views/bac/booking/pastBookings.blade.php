...
<div>
    ...
    <div class="row">
        ...
        <div class="card">
				...
				<form action="{{route('pastBookings')}}" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="form-group col-sm-3">
							<label for="defaultSelect">Start Date</label>
							<input type="date" required class="form-control form-control" name="stdate" id="stdate"/>
						</div>
						<div class="form-group col-sm-3">
							<label for="defaultSelect">End Date</label>
							<input type="date" required class="form-control form-control" name="enddate" id="stdate"/>
						</div>
						<div class="form-group col-sm-3">
